...
int main(int argc, char* argv[]) {
    ...
    // int minHessian = 500;
    cv::Ptr<cv::SIFT> detector1 = cv::SIFT::create();
    cv::Ptr<cv::SIFT> detector2 = cv::SIFT::create();
    ...
    cv::imwrite("SIFT_image_stitching_Matches.jpeg", imageMatches);
    ...
    cv::imshow("SIFT_Panoramic View", warpedImg1);
    cv::imwrite("SIFT_panoramic_view.jpeg", warpedImg1);
