...
int main(int argc, char* argv[])
{
    ...
    int minHessian = 500;
    cv::Ptr<cv::xfeatures2d::SURF> detector1 = cv::xfeatures2d::SURF::create(minHessian);
    cv::Ptr<cv::xfeatures2d::SURF> detector2 = cv::xfeatures2d::SURF::create(minHessian);
    ...
    std::cout << "FPS: " << fps <<"\n"<< std::endl;
    cv::imwrite("panoramic_view_SURF.jpg", warpedFrame1);
    cv::imwrite("SURF_stitching_Matches.jpg", frameMatches);
